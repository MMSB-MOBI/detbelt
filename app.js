...
var socket = io.connect(cst.SERVER_URL);
...
//-----
    ...
    cpSubmitBox.on("ngl_ok",function(fileContent){
        ...
        let url = cst.SERVER_URL + "/apiDet/getallid/"
...
// added by Sébastien Delolme-Sabatier 
    ...
    cpDetBox.on("askInfos",function(request){
        let url = cst.SERVER_URL + "/apiDet/getOne/"+request
        let to_send = {};
     ...
     document.addEventListener('askResults',function(to_find){
        console.log("app.js white askResults")
        let url = cst.SERVER_URL + "/apiWhite/results/"+to_find.detail;
